...
\begin{figure}[h!]
    %\centering
  \includegraphics[width=100mm]{arima1}
...
\begin{wrapfigure}
    \centering
    \includegraphics[width=\textwidth]{arima2}
...
\begin{figure}[h!]
    \centering
    \includegraphics[max size={\textwidth\textheight}]{arima3}
...
\begin{figure*}[h!]
            \centering
            \includegraphics{layers1.jpg}
            \caption{Layers shown in a neural network}
        \end{figure*}
\begin{figure}[h!]
            \centering
            \includegraphics{layers2.jpg}
...
\begin{figure}[h!]
    \centering
    \includegraphics{rnn1.jpg}
    \caption{RNN visualised }
\end{figure}
\begin{figure}[h!]
    \centering
    \includegraphics{rnn2.jpg}
    \caption{RNN broken down into individual components }
\end{figure}
\begin{figure}[h!]
    \centering
    \includegraphics{rnn3.jpg}
    \caption{}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics{transformer1.jpg}
    \caption{}
(Vaswani et al., 2017)
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.25\textwidth]{grn.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.25\textwidth]{vsn.png}}
...
\begin{wrapfigure}{l}{0.25\textwidth}
    \centering
    \includegraphics[width=0.25\textwidth]{codinglan1.png}
\end{wrapfigure}
\begin{wrapfigure}{l}{0.25\textwidth}
    \centering
    \includegraphics[width=0.25\textwidth]{codinglan2.png}
\end{wrapfigure}
...
\begin{algorithmic}
\For{pos in range(maximum sequence length)}
    \For{item in range(model)}
